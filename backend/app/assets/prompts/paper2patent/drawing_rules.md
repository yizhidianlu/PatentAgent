...
source_path: skills/paper2patent/references/drawing-generation.md
source_url: https://github.com/7toCR/paper2patent
treatment: verbatim
ported_version: 2026-08-25.1
notes: 来源 7toCR/paper2patent，依 CLAUSE.md 署名。全文逐字复制（原文为英文，为保 verbatim 未翻译）；文中 generate_patent_drawings.py 脚本由平台服务端 services/drawings.py 以子进程执行，prompt 不再指挥脚本调用。
---
